...
const tourPackagesData: TourPackage[] = [
  {
    ...
    longDescription: "Immerse yourself in the rich cultural heritage of Sri Lanka with this comprehensive 7-day journey. From the ancient rock fortress of Sigiriya to the sacred Temple of the Tooth in Kandy, experience the fascinating history and spiritual traditions that have shaped this beautiful island nation.",
