...
// Sample tour data - you can fetch this based on tour ID
const tourDetails = {
  id: 1,
  ...
  image: "/sigiriya.jpg",
  highlights: [
    "Pickup from Downsouth Hotels",
    "Sigiriya Rock Fortress",
    "Nuwara Eliya Tea Country", 
    "Ella Nine Arch Bridge",
    "Udawalawe Safari",
    "Drop to Downsouth Hotels"
  ]
};
...
export default function BookingFormPage() {
  ...
  const countries = [
    ...
    'France', 'Japan', 'Singapore', 'India', 'Netherlands', 'Sweden',
    'Norway', 'Switzerland', 'New Zealand', 'South Africa'
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <Card className="animate-fade-in-left">
              <CardHeader>
                <CardTitle className="text-2xl text-gray-900">Book Your Tour</CardTitle>
                <CardDescription className="text-gray-600">
                  Fill in your details below and we'll get back to you with the best package for your needs
                </CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <Label htmlFor="tourPackage" className="text-sm font-medium">
                        Select Tour Packages <span className="text-red-500">*</span>
                      </Label>
                      <Select
                        value={formData.tourPackage}
                        onValueChange={(value) => handleInputChange('tourPackage', value)}
                        required
                      >
          ...
          <div className="space-y-6">
              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg border border-blue-200">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-700">info@lankaumeshtours.com</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-3 bg-orange-50 rounded-lg border border-orange-200">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-orange-700">Koggala, Sri Lanka</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            {/* Why Choose Us */}
            <Card className="animate-fade-in-right" style={{ animationDelay: '0.4s' }}>
              <CardHeader>
