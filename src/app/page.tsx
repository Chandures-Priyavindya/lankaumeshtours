...
*Date:* ${new Date().toLocaleDateString()}
  ...
  const tourPackages = [
    ...
    },
    {
      ...
      rating: 4.7,
      image: "/udawalawa.jpg",
      description: "Yala Safari & Ella Tour",
      highlights: [
    ...
    },
    {
      ...
      rating: 4.7,
      image: "/udawalawa.jpg",
      description: "Udawalawa Safari & Ella Tour",
      highlights: [
        "Pickup from Hikkaduwa/Galle/Mirissa",
        "Nine Arches Bridge",
        "Little Adam's Peak",
    ...
    },
    {
      ...
      highlights: [
        "Pickup Colombo Airport(CMB) or Mirissa,Weligama,Unawatuna,Galle,Hikkaduwa",
        "Drop Colombo Airport(CMB) or Mirissa,Weligama,Unawatuna,Galle,Hikkaduwa",
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      image:
        "https://thafd.bing.com/th/id/OIP.mTH8GtRVqcf1Lv1ir8lbcgHaJ4?w=128&h=180&c=7&r=0&o=7&cb=thfc1&pid=1.7&rm=3",
    },
    {
      name: "Ruhi balha",
      location: "Singapore",
    ...
    },
    {
      ...
      rating: 5,
      image:
        "https://thafd.bing.com/th/id/OIP.lKJ3LJRkKO_KCixe8kL4zwHaHa?w=170&h=180&c=7&r=0&o=5&cb=thfc1&pid=1.7",
    },
  ];
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400 animate-fade-in-up">
            <p>
              &copy; 2025 Lanka Umesh Tours. Developed by{" "}
              <a
                href="https://chandurespriyavindya.vercel.app/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-400 hover:underline"
              >
                chandurespriyavindya
              </a>
              . All rights reserved.
            </p>
          </div>
